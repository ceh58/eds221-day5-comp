...
# The line below is a time vector of 8 years.
time_yr <- seq(from = 0, to = 8, by = 1)

# The line below is an empty matrix to return the population for each life stage at each year.
proj_year <- matrix(ncol = length(fish_year0), nrow = length(time_yr))

# The line below is to store the initial population in row 1.
proj_year[1, ] <- fish_year0

# The for loop below fills out the matrix for all the populations following the initial population.
